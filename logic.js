...
const bouncingBall = function () {
	...
	this.friction = 0.5;
	this.size = this.constructor.prototype.SIZE;
	this.color = '#ff9933';
	this.stop = false;
	this.stopTimes = 0;
	this.stopLimit = 10;
...
/* change ball size regarding screen size */
if (screen.width <= 960) {
	bouncingBall.prototype.SIZE = 20;

	if (screen.height < 768) {
		bouncingBall.prototype.SIZE = 17;
	}
} else if (screen.width > 960) {
	bouncingBall.prototype.SIZE = 30;
}
